...
Lets import the dataset of nuclei count. The dataset is found [here](https://github.com/KarlssonLaboratory/mi8016-Research-Approaches/blob/main/data/proliferation.csv). We will download it directly into R with the `read_csv()` function (`readr` packages)
